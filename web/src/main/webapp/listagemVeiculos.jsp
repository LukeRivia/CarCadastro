	...
	<table class="table">
	  ...
	  <c:forEach items="${veiculo}" var="atributo">
		    <tr>
		      ...
		      <td>		      				       
		         <a href="/web/removeEmpresaServlet?id=${atributo.id}"><img src="estilo/trash.svg" width="18px"></a>
		         <a href="/web/alterarDados?id=${atributo.id}"><img src="estilo/create.svg" width="18px"></a>	       
		      </td>
		    </tr>
		</c:forEach>
	  </tbody>
